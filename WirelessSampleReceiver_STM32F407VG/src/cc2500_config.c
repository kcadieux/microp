...
uint16_t			 	CC2500_SPI_SCLK_GPIO_PIN =			GPIO_Pin_13;
...
uint16_t 				CC2500_SPI_CSN_GPIO_PIN =				GPIO_Pin_12;
...
uint16_t 				CC2500_SPI_MISO_GPIO_PIN =			GPIO_Pin_14;
...
uint16_t 				CC2500_SPI_MOSI_GPIO_PIN =			GPIO_Pin_15;
